...
"resource": {
  ...
  "tags":[{
      ...
      "setup_tags":["list",["tag",0,1]],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003Efbq(\"trackCustom\",\"NewUserPurchase\",{value:",["escape",["macro",2],8,16],",currency:\"USD\"});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",3,45]],
    [["if",5,6],["add",4,11,12,15,17,18,22,25,27,43,55,56,63,64,1,67,2,70,71]],
    [["if",3,7],["add",5,6]],
    [["if",3,4],["add",7],["block",3,9,37,0,42,49,52,57,61]],
    [["if",3],["add",7,42,57,60,29,30,32,33,34]],
    [["if",3,9],["unless",8],["add",8,16,45]],
    [["if",10,11],["add",9]],
    [["if",12,13,14],["add",10]],
    [["if",3,15],["add",13,47]],
    [["if",14,16,17],["add",14,48]],
    [["if",3,18],["add",16,45]],
    [["if",3,19],["add",16]],
    [["if",3,20],["add",16,45],["block",49]],
    [["if",3,18,21],["add",16,45]],
    [["if",3,22],["add",16,45]],
    [["if",3,23],["add",16,45]],
    [["if",3,24],["add",16,45]],
    [["if",3,25],["add",16,45]],
    [["if",3,26],["add",16]],
    [["if",3,27],["add",19,45,45]],
    [["if",28],["add",20]],
    [["if",3,29],["add",21,24,53]],
    [["if",3,30],["add",23,28,44,1,65,2,68]],
    [["if",3,31],["add",26]],
    [["if",3,32],["add",26]],
    [["if",3,33],["add",26]],
    [["if",3,34],["add",31]],
    [["if",37],["unless",35,36],["add",35]],
    [["if",38],["add",36]],
    [["if",3,39],["add",37],["block",49,57,62]],
    [["if",3,40],["unless",41],["add",37]],
    [["if",42,43],["add",37]],
    [["if",3,46],["add",0]],
    [["if",48,49],["add",38]],
    [["if",38,50],["add",39]],
    [["if",14,51],["add",40,58,1,66,2,69]],
    [["if",52,53],["add",41]],
    [["if",3,54],["add",45]],
    [["if",3,55],["add",45]],
    [["if",3,56],["add",45],["block",49]],
    [["if",3,57],["add",45]],
    [["if",3,58],["add",45]],
    [["if",3],["unless",59],["add",45]],
    [["if",3,60],["add",45]],
    [["if",3,61],["add",45]],
    [["if",3,62],["add",45]],
    [["if",3,63],["add",45]],
    [["if",3,64],["add",45]],
    [["if",0,2,3],["unless",1],["add",45]],
    [["if",3,65],["unless",66,67],["add",45]],
    [["if",3,68],["add",45]],
    [["if",5,69],["add",46]],
    [["if",0,3],["unless",1,44],["add",49,61]],
    [["if",5,6,74],["add",50,51]],
    [["if",0,3,74],["add",52]],
    [["if",75,76,77,78],["add",54]],
    [["if",14,79],["add",59]],
    [["if",76,78,80],["add",62]],
    [["if",3,44],["block",37,0]],
    [["if",3,45],["block",37]],
    [["if",3,47],["block",0]],
    [["if",3,70],["block",49,57,62]],
    [["if",3,71],["block",49,57,62]],
    [["if",3,72],["block",49,57,62]],
    [["if",3,73],["block",49]]]
},
"runtime":[
[],[]
...
function Fc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.M[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Hc={},Ic=null,Jc=Math.random();Hc.i="GTM-7BF3X";Hc.Ab="8l2";var Kc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},Lc="www.googletagmanager.com/gtm.js";var Mc=Lc,Nc=null,Oc=null,Pc=null,Qc="//www.googletagmanager.com/a?id="+Hc.i+"&cv=319",Rc={},Sc={},Tc=function(){var a=Ic.sequence||0;Ic.sequence=a+1;return a};
...
Y.a.tg=["google"],function(){function a(k){h.push(k);1<h.length||D(function(){var l=h.join(",");h=[];wi({event:"gtm.triggerGroup","gtm.triggers":l})})}function b(k,l){var m=d[l],n=m.indexOf(k);-1!==n&&(m.splice(n,1),m.length||a(l))}function c(k){D(k.vtp_gtmOnSuccess);var l=k.vtp_uniqueTriggerId,m=k.vtp_triggerIds,n=k.vtp_firingId;if(k.vtp_isListeningTag){var p=e[n];p?b(n,p):g.push(n)}else{d[l]=m;for(var t=0,q;q=m[t];t++)e[q]=l;for(var r=0;r<g.length;r++)b(g[r],l)}}var d={},e={},g=[],h=[];Y.__tg=c;Y.__tg.b="tg";Y.__tg.g=!0;Y.__tg.priorityOverride=0}();
